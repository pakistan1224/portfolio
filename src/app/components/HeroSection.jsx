  ...
  <div className="grid grid-cols-1 sm:grid-cols-12">
    <motion.div initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }}
      ...
      <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
        ...
        <br></br>
        <TypeAnimation sequence={[ "Izaz Khattak" , 1000, "Web Developer" , 1000, "Web Designer" ,
          1000, "MERN Developer" , 1000, ]} wrapper="span" speed={50} repeat={Infinity} />
      </h1>
      <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
        I'm a Full Stack Web Developer and I have worked on so many technologies like PHP,Laravel,Bootstrap,Tailwind and
        many more !!!
      </p>
      <div>
  <a
    href="Professional CV Resume.pdf"
    download="Professional CV Resume.pdf"
